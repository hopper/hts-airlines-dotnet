...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class SessionsApi : ISessionsApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AirlineSession> localVarResponse = PostSessionsWithHttpInfo(createAirlineSessionRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AirlineSession</returns>
        public Org.OpenAPITools.Client.ApiResponse<AirlineSession> PostSessionsWithHttpInfo(CreateAirlineSessionRequest createAirlineSessionRequest, int operationIndex = 0)
        {
            // verify the required parameter 'createAirlineSessionRequest' is set
            if (createAirlineSessionRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'createAirlineSessionRequest' when calling SessionsApi->PostSessions");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AirlineSession> localVarResponse = await PostSessionsWithHttpInfoAsync(createAirlineSessionRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
