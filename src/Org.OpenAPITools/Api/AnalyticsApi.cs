...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class AnalyticsApi : IAnalyticsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> PostCustomerEventsWithHttpInfo(CfarEvent cfarEvent, int operationIndex = 0)
        {
            // verify the required parameter 'cfarEvent' is set
            if (cfarEvent == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'cfarEvent' when calling AnalyticsApi->PostCustomerEvents");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> PostCustomerEventsWithHttpInfoAsync(CfarEvent cfarEvent, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'cfarEvent' is set
            if (cfarEvent == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> PostEventsWithHttpInfo(Event varEvent, int operationIndex = 0)
        {
            // verify the required parameter 'varEvent' is set
            if (varEvent == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'varEvent' when calling AnalyticsApi->PostEvents");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> PostEventsWithHttpInfoAsync(Event varEvent, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'varEvent' is set
            if (varEvent == null)
            {
