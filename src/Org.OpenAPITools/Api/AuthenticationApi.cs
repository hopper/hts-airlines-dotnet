...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AuthResponse> localVarResponse = PostAuthWithHttpInfo(authRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<AuthResponse> PostAuthWithHttpInfo(AuthRequest authRequest, int operationIndex = 0)
        {
            // verify the required parameter 'authRequest' is set
            if (authRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'authRequest' when calling AuthenticationApi->PostAuth");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AuthResponse> localVarResponse = await PostAuthWithHttpInfoAsync(authRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<AuthResponse>> PostAuthWithHttpInfoAsync(AuthRequest authRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'authRequest' is set
            if (authRequest == null)
            {
