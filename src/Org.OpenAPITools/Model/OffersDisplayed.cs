...
namespace Org.OpenAPITools.Model
{
    ...
    /// OffersDisplayed
    /// </summary>
    [DataContract(Name = "offers_displayed")]
    public partial class OffersDisplayed : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersDisplayed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OffersDisplayed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersDisplayed" /> class.
        /// </summary>
        ...
        public OffersDisplayed(DateTime occurredDateTime = default(DateTime), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for OffersDisplayed and cannot be null");
            }
            this.Type = type;
        }
