...
namespace Org.OpenAPITools.Model
{
    ...
    /// OffersDisplayed1
    /// </summary>
    [DataContract(Name = "offers_displayed1")]
    public partial class OffersDisplayed1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersDisplayed1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OffersDisplayed1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersDisplayed1" /> class.
        /// </summary>
        ...
        public OffersDisplayed1(DateTime occurredDateTime = default(DateTime), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for OffersDisplayed1 and cannot be null");
            }
            this.Type = type;
        }
