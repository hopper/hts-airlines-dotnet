...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dg_exercise_customer_data_complete")]
    public partial class DgExerciseCustomerDataComplete : IValidatableObject
    {
        ...
        protected DgExerciseCustomerDataComplete() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DgExerciseCustomerDataComplete" /> class.
        /// </summary>
        ...
        public DgExerciseCustomerDataComplete(DateTime occurredDateTime = default(DateTime), string dgExerciseId = default(string), ExerciseStepResult result = default(ExerciseStepResult), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "dgExerciseId" is required (not null)
            if (dgExerciseId == null)
            {
                throw new ArgumentNullException("dgExerciseId is a required property for DgExerciseCustomerDataComplete and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for DgExerciseCustomerDataComplete and cannot be null");
            }
            this.Type = type;
        }
