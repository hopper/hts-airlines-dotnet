...
namespace Org.OpenAPITools.Model
{
    ...
    /// BookingConfirmed
    /// </summary>
    [DataContract(Name = "booking_confirmed")]
    public partial class BookingConfirmed : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BookingConfirmed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmed" /> class.
        /// </summary>
        ...
        public BookingConfirmed(DateTime occurredDateTime = default(DateTime), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BookingConfirmed and cannot be null");
            }
            this.Type = type;
        }
