...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cfar_exercise_verification_complete")]
    public partial class CfarExerciseVerificationComplete : IValidatableObject
    {
        ...
        protected CfarExerciseVerificationComplete() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarExerciseVerificationComplete" /> class.
        /// </summary>
        ...
        public CfarExerciseVerificationComplete(DateTime occurredDateTime = default(DateTime), string cfarExerciseId = default(string), ExerciseStepResult result = default(ExerciseStepResult), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "cfarExerciseId" is required (not null)
            if (cfarExerciseId == null)
            {
                throw new ArgumentNullException("cfarExerciseId is a required property for CfarExerciseVerificationComplete and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for CfarExerciseVerificationComplete and cannot be null");
            }
            this.Type = type;
        }
