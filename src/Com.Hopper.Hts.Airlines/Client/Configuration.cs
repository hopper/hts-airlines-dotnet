...
namespace Com.Hopper.Hts.Airlines.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.1.10/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://airlines-api.hopper.com/airline/v1.1") : this()
        {
        ...
        {
            string report = "C# SDK (Com.Hopper.Hts.Airlines) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: v1.1\n";
            report += "    SDK Package Version: 0.1.10\n";
