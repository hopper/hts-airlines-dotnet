...
[assembly: InternalsVisibleTo("Com.Hopper.Hts.Airlines.Test")]
...
namespace Com.Hopper.Hts.Airlines.Client
{
    ...
    public static class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            switch(value)
            {
                case ApiKeyHeader.HC_Session_ID:
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is DgPassengerType dgPassengerType)
                return DgPassengerTypeValueConverter.ToJsonValue(dgPassengerType);
            if (obj is DgRequestType dgRequestType)
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://airlines-api.hopper.com/airline/v1.1";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/airline/v1.1";

        /// <summary>
        /// The host of the API
        /// </summary>
        public const string HOST = "airlines-api.hopper.com";
