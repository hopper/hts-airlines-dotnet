...
namespace Com.Hopper.Hts.Airlines.Api
{
    ...
    /// <summary>
    /// The <see cref="IPostCustomerDgEventsApiResponse"/>
    /// </summary>
    public interface IPostCustomerDgEventsApiResponse : Com.Hopper.Hts.Airlines.Client.IApiResponse, IBadRequest<Com.Hopper.Hts.Airlines.Model.BadRequest?>, IUnprocessableContent<Com.Hopper.Hts.Airlines.Model.UnprocessableEntity?>
    {
        /// <summary>
    ...
    public class DisruptionGuaranteeDGApiEvents
    {
        ...
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnPostCustomerDgEvents;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorPostCustomerDgEvents;

        internal void ExecuteOnPostCustomerDgEvents(DisruptionGuaranteeDGApi.PostCustomerDgEventsApiResponse apiResponse)
        {
            OnPostCustomerDgEvents?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorPostCustomerDgEvents(Exception exception)
        {
            OnErrorPostCustomerDgEvents?.Invoke(this, new ExceptionEventArgs(exception));
        }
    ...
    public sealed partial class DisruptionGuaranteeDGApi : IDisruptionGuaranteeDGApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<PostCustomerDgEventsApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<PostCustomerDgEventsApiResponse>();
        ...
        /// <summary>
        /// The <see cref="PostCustomerDgEventsApiResponse"/>
        /// </summary>
        public partial class PostCustomerDgEventsApiResponse : Com.Hopper.Hts.Airlines.Client.ApiResponse, IPostCustomerDgEventsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<PostCustomerDgEventsApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public PostCustomerDgEventsApiResponse(ILogger<PostCustomerDgEventsApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
