...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class Edge
    {
        ...
        [JsonConstructor]
        public Edge(string type, Option<string?> varVersion = default)
        {
            Type = type;
    ...
    public class EdgeJsonConverter : JsonConverter<Edge>
    {
        ...
        public override Edge Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Edge(type.Value!, varVersion);
        }
        ...
        {
            if (edge.Type == null)
                throw new ArgumentNullException(nameof(edge.Type), "Property is required for class Edge.");
