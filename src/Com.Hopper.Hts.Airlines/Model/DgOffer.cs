...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class DgOffer
    {
        ...
        /// <param name="minMinutesDelay">The minimum flight or slice departure delay in hours to be covered</param>
    ...
    /// <summary>
    /// A Json converter for type <see cref="DgOffer" />
    /// </summary>
    public class DgOfferJsonConverter : JsonConverter<DgOffer>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DgOffer" />
        /// </summary>
        ...
        public override DgOffer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(id));

            if (!premium.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(premium));

            if (!coverage.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(coverage));

            if (!coveragePercentage.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(coveragePercentage));

            if (!serviceCap.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(serviceCap));

            if (!currency.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(currency));

            if (!taxesTotal.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(taxesTotal));

            if (!requestType.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(requestType));

            if (!maxHoursBeforeDeparture.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(maxHoursBeforeDeparture));

            if (!minMinutesDelay.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(minMinutesDelay));

            if (!contractExpiryDateTime.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(contractExpiryDateTime));

            if (!createdDateTime.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(createdDateTime));

            if (!itinerary.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(itinerary));

            if (!extAttributes.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(extAttributes));

            if (!experiments.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(experiments));

            if (!contents.IsSet)
                throw new ArgumentException("Property is required for class DgOffer.", nameof(contents));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class DgOffer.");

            if (premium.IsSet && premium.Value == null)
                throw new ArgumentNullException(nameof(premium), "Property is not nullable for class DgOffer.");

            if (coverage.IsSet && coverage.Value == null)
                throw new ArgumentNullException(nameof(coverage), "Property is not nullable for class DgOffer.");

            if (coveragePercentage.IsSet && coveragePercentage.Value == null)
                throw new ArgumentNullException(nameof(coveragePercentage), "Property is not nullable for class DgOffer.");

            if (serviceCap.IsSet && serviceCap.Value == null)
                throw new ArgumentNullException(nameof(serviceCap), "Property is not nullable for class DgOffer.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class DgOffer.");

            if (taxesTotal.IsSet && taxesTotal.Value == null)
                throw new ArgumentNullException(nameof(taxesTotal), "Property is not nullable for class DgOffer.");

            if (requestType.IsSet && requestType.Value == null)
                throw new ArgumentNullException(nameof(requestType), "Property is not nullable for class DgOffer.");

            if (maxHoursBeforeDeparture.IsSet && maxHoursBeforeDeparture.Value == null)
                throw new ArgumentNullException(nameof(maxHoursBeforeDeparture), "Property is not nullable for class DgOffer.");

            if (minMinutesDelay.IsSet && minMinutesDelay.Value == null)
                throw new ArgumentNullException(nameof(minMinutesDelay), "Property is not nullable for class DgOffer.");

            if (contractExpiryDateTime.IsSet && contractExpiryDateTime.Value == null)
                throw new ArgumentNullException(nameof(contractExpiryDateTime), "Property is not nullable for class DgOffer.");

            if (createdDateTime.IsSet && createdDateTime.Value == null)
                throw new ArgumentNullException(nameof(createdDateTime), "Property is not nullable for class DgOffer.");

            if (itinerary.IsSet && itinerary.Value == null)
                throw new ArgumentNullException(nameof(itinerary), "Property is not nullable for class DgOffer.");

            if (extAttributes.IsSet && extAttributes.Value == null)
                throw new ArgumentNullException(nameof(extAttributes), "Property is not nullable for class DgOffer.");

            if (experiments.IsSet && experiments.Value == null)
                throw new ArgumentNullException(nameof(experiments), "Property is not nullable for class DgOffer.");
        ...
        /// <summary>
        /// Serializes a <see cref="DgOffer" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dgOffer"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DgOffer dgOffer, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dgOffer, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DgOffer" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dgOffer"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DgOffer dgOffer, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dgOffer.Id == null)
                throw new ArgumentNullException(nameof(dgOffer.Id), "Property is required for class DgOffer.");

            if (dgOffer.Premium == null)
                throw new ArgumentNullException(nameof(dgOffer.Premium), "Property is required for class DgOffer.");

            if (dgOffer.Coverage == null)
                throw new ArgumentNullException(nameof(dgOffer.Coverage), "Property is required for class DgOffer.");

            if (dgOffer.CoveragePercentage == null)
                throw new ArgumentNullException(nameof(dgOffer.CoveragePercentage), "Property is required for class DgOffer.");

            if (dgOffer.ServiceCap == null)
                throw new ArgumentNullException(nameof(dgOffer.ServiceCap), "Property is required for class DgOffer.");

            if (dgOffer.Currency == null)
                throw new ArgumentNullException(nameof(dgOffer.Currency), "Property is required for class DgOffer.");

            if (dgOffer.TaxesTotal == null)
                throw new ArgumentNullException(nameof(dgOffer.TaxesTotal), "Property is required for class DgOffer.");

            if (dgOffer.Itinerary == null)
                throw new ArgumentNullException(nameof(dgOffer.Itinerary), "Property is required for class DgOffer.");

            if (dgOffer.ExtAttributes == null)
                throw new ArgumentNullException(nameof(dgOffer.ExtAttributes), "Property is required for class DgOffer.");

            if (dgOffer.Experiments == null)
                throw new ArgumentNullException(nameof(dgOffer.Experiments), "Property is required for class DgOffer.");
            ...
            writer.WriteString("premium", dgOffer.Premium);

            writer.WriteString("coverage", dgOffer.Coverage);

            writer.WriteString("coverage_percentage", dgOffer.CoveragePercentage);

            writer.WriteString("service_cap", dgOffer.ServiceCap);

            writer.WriteString("currency", dgOffer.Currency);

            writer.WriteString("taxes_total", dgOffer.TaxesTotal);

            var requestTypeRawValue = DgRequestTypeValueConverter.ToJsonValue(dgOffer.RequestType);
            writer.WriteString("request_type", requestTypeRawValue);

            writer.WriteNumber("max_hours_before_departure", dgOffer.MaxHoursBeforeDeparture);

            writer.WriteNumber("min_minutes_delay", dgOffer.MinMinutesDelay);

            writer.WriteString("contract_expiry_date_time", dgOffer.ContractExpiryDateTime.ToString(ContractExpiryDateTimeFormat));

            writer.WriteString("created_date_time", dgOffer.CreatedDateTime.ToString(CreatedDateTimeFormat));

            writer.WritePropertyName("itinerary");
            JsonSerializer.Serialize(writer, dgOffer.Itinerary, jsonSerializerOptions);
            writer.WritePropertyName("ext_attributes");
            JsonSerializer.Serialize(writer, dgOffer.ExtAttributes, jsonSerializerOptions);
            writer.WritePropertyName("experiments");
            JsonSerializer.Serialize(writer, dgOffer.Experiments, jsonSerializerOptions);
            writer.WritePropertyName("contents");
            JsonSerializer.Serialize(writer, dgOffer.Contents, jsonSerializerOptions);
            if (dgOffer.TaxesOption.IsSet)
            {
                writer.WritePropertyName("taxes");
                JsonSerializer.Serialize(writer, dgOffer.Taxes, jsonSerializerOptions);
            }
            if (dgOffer.EntryPointOption.IsSet)
                writer.WriteString("entry_point", dgOffer.EntryPoint);
            ...
            if (dgOffer.MerchandisingUrlWebComponentOption.IsSet)
                writer.WriteString("merchandising_url_web_component", dgOffer.MerchandisingUrlWebComponent);
        }
    }
}
