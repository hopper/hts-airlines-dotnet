...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class Chrome
    {
        ...
        [JsonConstructor]
        public Chrome(TypeEnum type, Option<string?> varVersion = default)
        {
            Type = type;
    ...
    public class ChromeJsonConverter : JsonConverter<Chrome>
    {
        ...
        public override Chrome Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Chrome.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<Chrome.TypeEnum?>(Chrome.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "version":
