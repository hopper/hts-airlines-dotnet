...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class Opera
    {
        ...
        [JsonConstructor]
        public Opera(TypeEnum type, Option<string?> varVersion = default)
        {
            Type = type;
    ...
    public class OperaJsonConverter : JsonConverter<Opera>
    {
        ...
        public override Opera Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Opera.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<Opera.TypeEnum?>(Opera.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "version":
