...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dg_itinerary_slice_segment")]
    public partial class DgItinerarySliceSegment : IValidatableObject
    {
        ...
        protected DgItinerarySliceSegment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DgItinerarySliceSegment" /> class.
        /// </summary>
        ...
        public DgItinerarySliceSegment(string segmentId = default(string), string originAirport = default(string), string destinationAirport = default(string), string departureDateTime = default(string), string arrivalDateTime = default(string), string flightNumber = default(string), string validatingCarrierCode = default(string), Cabin cabin = default(Cabin), string fareBrand = default(string))
        {
            // to ensure "originAirport" is required (not null)
            if (originAirport == null)
            {
                throw new ArgumentNullException("originAirport is a required property for DgItinerarySliceSegment and cannot be null");
            }
            this.OriginAirport = originAirport;
            // to ensure "destinationAirport" is required (not null)
            if (destinationAirport == null)
            {
                throw new ArgumentNullException("destinationAirport is a required property for DgItinerarySliceSegment and cannot be null");
            }
            this.DestinationAirport = destinationAirport;
            // to ensure "departureDateTime" is required (not null)
            if (departureDateTime == null)
            {
                throw new ArgumentNullException("departureDateTime is a required property for DgItinerarySliceSegment and cannot be null");
            }
            this.DepartureDateTime = departureDateTime;
            // to ensure "arrivalDateTime" is required (not null)
            if (arrivalDateTime == null)
            {
                throw new ArgumentNullException("arrivalDateTime is a required property for DgItinerarySliceSegment and cannot be null");
            }
            this.ArrivalDateTime = arrivalDateTime;
            // to ensure "flightNumber" is required (not null)
            if (flightNumber == null)
            {
                throw new ArgumentNullException("flightNumber is a required property for DgItinerarySliceSegment and cannot be null");
            }
            this.FlightNumber = flightNumber;
            // to ensure "validatingCarrierCode" is required (not null)
            if (validatingCarrierCode == null)
            {
                throw new ArgumentNullException("validatingCarrierCode is a required property for DgItinerarySliceSegment and cannot be null");
            }
