...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// OffersDisplayed
    /// </summary>
    public partial class OffersDisplayed
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OffersDisplayed" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="OffersDisplayed" />
    /// </summary>
    public class OffersDisplayedJsonConverter : JsonConverter<OffersDisplayed>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="OffersDisplayed" />
        /// </summary>
        ...
        public override OffersDisplayed Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!occurredDateTime.IsSet)
                throw new ArgumentException("Property is required for class OffersDisplayed.", nameof(occurredDateTime));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class OffersDisplayed.", nameof(type));

            if (occurredDateTime.IsSet && occurredDateTime.Value == null)
                throw new ArgumentNullException(nameof(occurredDateTime), "Property is not nullable for class OffersDisplayed.");
        ...
        /// <summary>
        /// Serializes a <see cref="OffersDisplayed" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="offersDisplayed"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OffersDisplayed offersDisplayed, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, offersDisplayed, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OffersDisplayed" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="offersDisplayed"></param>
        /// <param name="jsonSerializerOptions"></param>
