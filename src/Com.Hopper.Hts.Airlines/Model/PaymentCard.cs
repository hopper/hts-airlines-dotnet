...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class PaymentCard
    {
        ...
        public PaymentCard(string amount = default(string), string currency = default(string), string token = default(string), string lastFourDigits = default(string), string expirationMonth = default(string), string expirationYear = default(string), string type = default(string))
        {
