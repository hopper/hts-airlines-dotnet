...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// Mobile
    /// </summary>
    [DataContract(Name = "mobile")]
    public partial class Mobile : IValidatableObject
    {
        /// <summary>
        ...
        public Mobile(string id = default(string), Platform platform = default(Platform), string type = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Mobile and cannot be null");
            }
            this.Id = id;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Mobile and cannot be null");
            }
            this.Type = type;
