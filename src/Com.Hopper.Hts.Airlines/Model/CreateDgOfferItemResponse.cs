...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// A created Dg offer
    /// </summary>
    [DataContract(Name = "create_dg_offer_item_response")]
    public partial class CreateDgOfferItemResponse : IValidatableObject
    {
        ...
        protected CreateDgOfferItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDgOfferItemResponse" /> class.
        /// </summary>
        ...
        /// <param name="serviceCap">serviceCap (required).</param>
        ...
        public CreateDgOfferItemResponse(string id = default(string), string premium = default(string), string coverage = default(string), string coveragePercentage = default(string), string serviceCap = default(string), string currency = default(string), string taxesTotal = default(string), List<DgTax> taxes = default(List<DgTax>), DgRequestType requestType = default(DgRequestType), int maxHoursBeforeDeparture = default(int), int minMinutesDelay = default(int), DateTime createdDateTime = default(DateTime), DateTime contractExpiryDateTime = default(DateTime), DgItinerary itinerary = default(DgItinerary), Dictionary<string, string> extAttributes = default(Dictionary<string, string>), Dictionary<string, DgContents> contents = default(Dictionary<string, DgContents>))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "premium" is required (not null)
            if (premium == null)
            {
                throw new ArgumentNullException("premium is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.Premium = premium;
            // to ensure "coverage" is required (not null)
            if (coverage == null)
            {
                throw new ArgumentNullException("coverage is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.Coverage = coverage;
            // to ensure "coveragePercentage" is required (not null)
            if (coveragePercentage == null)
            {
                throw new ArgumentNullException("coveragePercentage is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.CoveragePercentage = coveragePercentage;
            // to ensure "serviceCap" is required (not null)
            if (serviceCap == null)
            {
                throw new ArgumentNullException("serviceCap is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.ServiceCap = serviceCap;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.Currency = currency;
            // to ensure "taxesTotal" is required (not null)
            if (taxesTotal == null)
            {
                throw new ArgumentNullException("taxesTotal is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            ...
            if (itinerary == null)
            {
                throw new ArgumentNullException("itinerary is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.Itinerary = itinerary;
            // to ensure "extAttributes" is required (not null)
            if (extAttributes == null)
            {
                throw new ArgumentNullException("extAttributes is a required property for CreateDgOfferItemResponse and cannot be null");
            }
            this.ExtAttributes = extAttributes;
            // to ensure "contents" is required (not null)
            if (contents == null)
            {
                throw new ArgumentNullException("contents is a required property for CreateDgOfferItemResponse and cannot be null");
            }
