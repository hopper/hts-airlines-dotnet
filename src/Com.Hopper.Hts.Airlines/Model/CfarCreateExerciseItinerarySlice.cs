...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cfar_create_exercise_itinerary_slice")]
    public partial class CfarCreateExerciseItinerarySlice
    {
        ...
        protected CfarCreateExerciseItinerarySlice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarCreateExerciseItinerarySlice" /> class.
        /// </summary>
        ...
        public CfarCreateExerciseItinerarySlice(List<CfarCreateExerciseSliceSegment> segments = default(List<CfarCreateExerciseSliceSegment>), List<PassengerPricing> passengerPricing = default(List<PassengerPricing>), string totalPrice = default(string), string fareBrand = default(string), string fareBasis = default(string), List<FareRule> fareRules = default(List<FareRule>), List<Fare> otherFares = default(List<Fare>))
        {
            // to ensure "segments" is required (not null)
            if (segments == null)
            {
                throw new ArgumentNullException("segments is a required property for CfarCreateExerciseItinerarySlice and cannot be null");
            }
