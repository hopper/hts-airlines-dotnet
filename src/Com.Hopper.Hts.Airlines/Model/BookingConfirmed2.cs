...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// BookingConfirmed2
    /// </summary>
    [DataContract(Name = "booking_confirmed2")]
    public partial class BookingConfirmed2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmed2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BookingConfirmed2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmed2" /> class.
        /// </summary>
        ...
        public BookingConfirmed2(DateTime occurredDateTime = default(DateTime), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for BookingConfirmed2 and cannot be null");
            }
            this.Type = type;
        }
