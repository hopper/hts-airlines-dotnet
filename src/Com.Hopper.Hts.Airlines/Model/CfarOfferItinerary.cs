...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cfar_offer_itinerary")]
    public partial class CfarOfferItinerary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarOfferItinerary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CfarOfferItinerary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarOfferItinerary" /> class.
        /// </summary>
        ...
        public CfarOfferItinerary(List<PassengerPricing> passengerPricing = default(List<PassengerPricing>), string currency = default(string), List<CfarItinerarySlice> slices = default(List<CfarItinerarySlice>), List<Ancillary> ancillaries = default(List<Ancillary>), string totalPrice = default(string), List<CfarOfferPassenger> passengers = default(List<CfarOfferPassenger>), List<FareRule> fareRules = default(List<FareRule>))
        {
            // to ensure "passengerPricing" is required (not null)
            if (passengerPricing == null)
            {
                throw new ArgumentNullException("passengerPricing is a required property for CfarOfferItinerary and cannot be null");
            }
            this.PassengerPricing = passengerPricing;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CfarOfferItinerary and cannot be null");
            }
            this.Currency = currency;
            // to ensure "slices" is required (not null)
            if (slices == null)
            {
                throw new ArgumentNullException("slices is a required property for CfarOfferItinerary and cannot be null");
            }
            this.Slices = slices;
        ...
        */
        ...
        public List<CfarOfferPassenger> Passengers { get; set; }
