...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="Linux" />
    /// </summary>
    public class LinuxJsonConverter : JsonConverter<Linux>
    {
        /// <summary>
        /// Deserializes json to <see cref="Linux" />
        /// </summary>
        ...
        public override Linux Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class Linux.", nameof(type));
        ...
        /// <summary>
        /// Serializes a <see cref="Linux" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="linux"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Linux linux, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, linux, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Linux" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="linux"></param>
        /// <param name="jsonSerializerOptions"></param>
