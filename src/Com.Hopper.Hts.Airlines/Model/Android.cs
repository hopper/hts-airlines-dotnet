...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class Android
    {
        ...
        [JsonConstructor]
        public Android(TypeEnum type, Option<string?> varVersion = default)
        {
            Type = type;
    ...
    public class AndroidJsonConverter : JsonConverter<Android>
    {
        ...
        public override Android Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Android.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<Android.TypeEnum?>(Android.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "version":
