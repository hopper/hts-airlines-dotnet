...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class Android
    {
        ...
        [JsonConstructor]
        public Android(string type, Option<string?> varVersion = default)
        {
            Type = type;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Android" />
    /// </summary>
    public class AndroidJsonConverter : JsonConverter<Android>
    {
        /// <summary>
        /// Deserializes json to <see cref="Android" />
        /// </summary>
        ...
        public override Android Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class Android.", nameof(type));
            ...
            return new Android(type.Value!, varVersion);
        }

        /// <summary>
        /// Serializes a <see cref="Android" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="android"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Android android, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, android, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Android" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="android"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        {
            if (android.Type == null)
                throw new ArgumentNullException(nameof(android.Type), "Property is required for class Android.");
            ...
            writer.WriteString("type", android.Type);

            if (android.VarVersionOption.IsSet)
                writer.WriteString("version", android.VarVersion);
        }
    }
}
