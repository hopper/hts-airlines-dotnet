...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "process_dg_payment_request")]
    public partial class ProcessDgPaymentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessDgPaymentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessDgPaymentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessDgPaymentRequest" /> class.
        /// </summary>
        /// <param name="paymentToken">The Token of the Form of Payment used to pay for the DG fee.  (required).</param>
        ...
        public ProcessDgPaymentRequest(string paymentToken = default(string), string firstName = default(string), string lastName = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string city = default(string), string stateOrProvince = default(string), string postalCode = default(string), string country = default(string), string pnrReference = default(string), string emailAddress = default(string), string phoneNumber = default(string))
        {
            // to ensure "paymentToken" is required (not null)
            if (paymentToken == null)
            {
                throw new ArgumentNullException("paymentToken is a required property for ProcessDgPaymentRequest and cannot be null");
            }
            this.PaymentToken = paymentToken;
            // to ensure "pnrReference" is required (not null)
            if (pnrReference == null)
            {
                throw new ArgumentNullException("pnrReference is a required property for ProcessDgPaymentRequest and cannot be null");
            }
            this.PnrReference = pnrReference;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for ProcessDgPaymentRequest and cannot be null");
            }
            this.EmailAddress = emailAddress;
            // to ensure "phoneNumber" is required (not null)
            if (phoneNumber == null)
            {
                throw new ArgumentNullException("phoneNumber is a required property for ProcessDgPaymentRequest and cannot be null");
            }
        ...
        */
        [DataMember(Name = "payment_token", IsRequired = true, EmitDefaultValue = true)]
