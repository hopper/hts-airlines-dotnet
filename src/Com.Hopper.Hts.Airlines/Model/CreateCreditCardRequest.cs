...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class CreateCreditCardRequest
    {
        ...
        public CreateCreditCardRequest(FlowType flowType = default(FlowType), UserInfo userInfo = default(UserInfo), Device device = default(Device), string pointOfSale = default(string), string language = default(string), Product? product = default(Product?))
        {
            this.FlowType = flowType;
            // to ensure "pointOfSale" is required (not null)
            if (pointOfSale == null)
            {
                throw new ArgumentNullException("pointOfSale is a required property for CreateCreditCardRequest and cannot be null");
            }
            this.PointOfSale = pointOfSale;
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for CreateCreditCardRequest and cannot be null");
            }
