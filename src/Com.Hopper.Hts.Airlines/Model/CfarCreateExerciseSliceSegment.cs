...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cfar_create_exercise_slice_segment")]
    public partial class CfarCreateExerciseSliceSegment
    {
        ...
        public CfarCreateExerciseSliceSegment(string originAirport = default(string), string destinationAirport = default(string), string departureDateTime = default(string), string arrivalDateTime = default(string), string flightNumber = default(string), string validatingCarrierCode = default(string), FareClass? fareClass = default(FareClass?), string fareBrand = default(string))
        {
            // to ensure "originAirport" is required (not null)
            if (originAirport == null)
            {
                throw new ArgumentNullException("originAirport is a required property for CfarCreateExerciseSliceSegment and cannot be null");
            }
            this.OriginAirport = originAirport;
            // to ensure "destinationAirport" is required (not null)
            if (destinationAirport == null)
            {
                throw new ArgumentNullException("destinationAirport is a required property for CfarCreateExerciseSliceSegment and cannot be null");
            }
            this.DestinationAirport = destinationAirport;
            // to ensure "departureDateTime" is required (not null)
            if (departureDateTime == null)
            {
                throw new ArgumentNullException("departureDateTime is a required property for CfarCreateExerciseSliceSegment and cannot be null");
            }
            this.DepartureDateTime = departureDateTime;
            // to ensure "arrivalDateTime" is required (not null)
            if (arrivalDateTime == null)
            {
                throw new ArgumentNullException("arrivalDateTime is a required property for CfarCreateExerciseSliceSegment and cannot be null");
            }
            this.ArrivalDateTime = arrivalDateTime;
            // to ensure "flightNumber" is required (not null)
            if (flightNumber == null)
            {
                throw new ArgumentNullException("flightNumber is a required property for CfarCreateExerciseSliceSegment and cannot be null");
            }
        ...
        */
        ...
        <example>B6</example>
        */
        [DataMember(Name = "validating_carrier_code", EmitDefaultValue = false)]
