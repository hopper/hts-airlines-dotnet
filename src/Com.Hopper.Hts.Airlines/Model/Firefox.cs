...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="Firefox" />
    /// </summary>
    public class FirefoxJsonConverter : JsonConverter<Firefox>
    {
        /// <summary>
        /// Deserializes json to <see cref="Firefox" />
        /// </summary>
        ...
        public override Firefox Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class Firefox.", nameof(type));
        ...
        /// <summary>
        /// Serializes a <see cref="Firefox" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="firefox"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Firefox firefox, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, firefox, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Firefox" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="firefox"></param>
        /// <param name="jsonSerializerOptions"></param>
