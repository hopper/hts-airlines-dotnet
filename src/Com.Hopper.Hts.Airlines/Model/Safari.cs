...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// Safari
    /// </summary>
    public partial class Safari
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Safari" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="Safari" />
    /// </summary>
    public class SafariJsonConverter : JsonConverter<Safari>
    {
        /// <summary>
        /// Deserializes json to <see cref="Safari" />
        /// </summary>
        ...
        public override Safari Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class Safari.", nameof(type));
        ...
        /// <summary>
        /// Serializes a <see cref="Safari" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="safari"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Safari safari, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, safari, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Safari" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="safari"></param>
        /// <param name="jsonSerializerOptions"></param>
