...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class CreateAirlineDgSessionRequest
    {
        ...
        [JsonConstructor]
        public CreateAirlineDgSessionRequest(string pointOfSale, string language, Option<UserInfo?> userInfo = default, Option<Device?> device = default, Option<string?> sessionId = default, Option<Channel?> channel = default)
        {
    ...
    public class CreateAirlineDgSessionRequestJsonConverter : JsonConverter<CreateAirlineDgSessionRequest>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateAirlineDgSessionRequest createAirlineDgSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createAirlineDgSessionRequest.ChannelOption.IsSet)
            {
                writer.WritePropertyName("channel");
                JsonSerializer.Serialize(writer, createAirlineDgSessionRequest.Channel, jsonSerializerOptions);
            }
        }
    }
}
