...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class UpdateCfarContractRequest
    {
        ...
        [JsonConstructor]
        public UpdateCfarContractRequest(CfarStatus status, Option<string?> pnrReference = default, Option<string?> emailAddress = default, Option<string?> phoneNumber = default, Option<string?> firstName = default, Option<string?> lastName = default, Option<string?> addressLine1 = default, Option<string?> addressLine2 = default, Option<string?> city = default, Option<string?> stateOrProvince = default, Option<string?> postalCode = default, Option<string?> country = default, Option<string?> taxesTotal = default, Option<List<CfarTax>?> taxes = default, Option<string?> currency = default, Option<string?> exchangeRate = default, Option<string?> totalPrice = default, Option<List<FormOfPayment>?> formsOfPayment = default)
        {
            Status = status;
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateCfarContractRequest" />
    /// </summary>
    public class UpdateCfarContractRequestJsonConverter : JsonConverter<UpdateCfarContractRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateCfarContractRequest" />
        /// </summary>
        ...
        public override UpdateCfarContractRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!status.IsSet)
                throw new ArgumentException("Property is required for class UpdateCfarContractRequest.", nameof(status));
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateCfarContractRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateCfarContractRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateCfarContractRequest updateCfarContractRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateCfarContractRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateCfarContractRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateCfarContractRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateCfarContractRequest updateCfarContractRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateCfarContractRequest.PnrReferenceOption.IsSet)
                writer.WriteString("pnr_reference", updateCfarContractRequest.PnrReference);

            if (updateCfarContractRequest.EmailAddressOption.IsSet)
                writer.WriteString("email_address", updateCfarContractRequest.EmailAddress);

            if (updateCfarContractRequest.PhoneNumberOption.IsSet)
                writer.WriteString("phone_number", updateCfarContractRequest.PhoneNumber);

            if (updateCfarContractRequest.FirstNameOption.IsSet)
                writer.WriteString("first_name", updateCfarContractRequest.FirstName);

            if (updateCfarContractRequest.LastNameOption.IsSet)
                writer.WriteString("last_name", updateCfarContractRequest.LastName);

            if (updateCfarContractRequest.AddressLine1Option.IsSet)
                writer.WriteString("address_line1", updateCfarContractRequest.AddressLine1);

            if (updateCfarContractRequest.AddressLine2Option.IsSet)
                writer.WriteString("address_line2", updateCfarContractRequest.AddressLine2);

            if (updateCfarContractRequest.CityOption.IsSet)
                writer.WriteString("city", updateCfarContractRequest.City);

            if (updateCfarContractRequest.StateOrProvinceOption.IsSet)
                writer.WriteString("state_or_province", updateCfarContractRequest.StateOrProvince);

            if (updateCfarContractRequest.PostalCodeOption.IsSet)
                writer.WriteString("postal_code", updateCfarContractRequest.PostalCode);

            if (updateCfarContractRequest.CountryOption.IsSet)
                writer.WriteString("country", updateCfarContractRequest.Country);

            if (updateCfarContractRequest.TaxesTotalOption.IsSet)
                writer.WriteString("taxes_total", updateCfarContractRequest.TaxesTotal);

            if (updateCfarContractRequest.TaxesOption.IsSet)
            {
                writer.WritePropertyName("taxes");
                JsonSerializer.Serialize(writer, updateCfarContractRequest.Taxes, jsonSerializerOptions);
            }
            if (updateCfarContractRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", updateCfarContractRequest.Currency);

            if (updateCfarContractRequest.ExchangeRateOption.IsSet)
                writer.WriteString("exchange_rate", updateCfarContractRequest.ExchangeRate);

            if (updateCfarContractRequest.TotalPriceOption.IsSet)
                writer.WriteString("total_price", updateCfarContractRequest.TotalPrice);

            if (updateCfarContractRequest.FormsOfPaymentOption.IsSet)
            {
                writer.WritePropertyName("forms_of_payment");
                JsonSerializer.Serialize(writer, updateCfarContractRequest.FormsOfPayment, jsonSerializerOptions);
            }
        }
    }
}
