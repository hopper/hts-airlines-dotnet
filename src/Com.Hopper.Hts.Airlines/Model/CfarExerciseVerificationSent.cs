...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cfar_exercise_verification_sent")]
    public partial class CfarExerciseVerificationSent : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarExerciseVerificationSent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CfarExerciseVerificationSent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CfarExerciseVerificationSent" /> class.
        /// </summary>
        ...
        public CfarExerciseVerificationSent(DateTime occurredDateTime = default(DateTime), string cfarExerciseId = default(string), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "cfarExerciseId" is required (not null)
            if (cfarExerciseId == null)
            {
                throw new ArgumentNullException("cfarExerciseId is a required property for CfarExerciseVerificationSent and cannot be null");
            }
            this.CfarExerciseId = cfarExerciseId;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for CfarExerciseVerificationSent and cannot be null");
            }
            this.Type = type;
        }
