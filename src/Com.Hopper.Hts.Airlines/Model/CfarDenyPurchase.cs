...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// CfarDenyPurchase
    /// </summary>
    [DataContract(Name = "cfar_deny_purchase")]
    public partial class CfarDenyPurchase : IValidatableObject
    {
        ...
        public CfarDenyPurchase(DateTime occurredDateTime = default(DateTime), List<string> cfarOffersIds = default(List<string>), UiSource uiSource = default(UiSource), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "cfarOffersIds" is required (not null)
            if (cfarOffersIds == null)
            {
                throw new ArgumentNullException("cfarOffersIds is a required property for CfarDenyPurchase and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for CfarDenyPurchase and cannot be null");
            }
            this.Type = type;
        }
