...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "create_cfar_contract_request")]
    public partial class CreateCfarContractRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCfarContractRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCfarContractRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCfarContractRequest" /> class.
        /// </summary>
        ...
        public CreateCfarContractRequest(List<string> offerIds = default(List<string>), CfarItinerary itinerary = default(CfarItinerary), Dictionary<string, string> extAttributes = default(Dictionary<string, string>), string pnrReference = default(string))
        {
            // to ensure "offerIds" is required (not null)
            if (offerIds == null)
            {
                throw new ArgumentNullException("offerIds is a required property for CreateCfarContractRequest and cannot be null");
            }
            this.OfferIds = offerIds;
            // to ensure "itinerary" is required (not null)
            if (itinerary == null)
            {
                throw new ArgumentNullException("itinerary is a required property for CreateCfarContractRequest and cannot be null");
            }
            this.Itinerary = itinerary;
            // to ensure "extAttributes" is required (not null)
            if (extAttributes == null)
            {
                throw new ArgumentNullException("extAttributes is a required property for CreateCfarContractRequest and cannot be null");
            }
