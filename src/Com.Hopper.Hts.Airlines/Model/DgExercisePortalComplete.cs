...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dg_exercise_portal_complete")]
    public partial class DgExercisePortalComplete : IValidatableObject
    {
        ...
        protected DgExercisePortalComplete() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DgExercisePortalComplete" /> class.
        /// </summary>
        ...
        public DgExercisePortalComplete(DateTime occurredDateTime = default(DateTime), string dgExerciseId = default(string), ExerciseStepResult result = default(ExerciseStepResult), string type = default(string))
        {
            this.OccurredDateTime = occurredDateTime;
            // to ensure "dgExerciseId" is required (not null)
            if (dgExerciseId == null)
            {
                throw new ArgumentNullException("dgExerciseId is a required property for DgExercisePortalComplete and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for DgExercisePortalComplete and cannot be null");
            }
            this.Type = type;
        }
