...
namespace Com.Hopper.Hts.Airlines.Model
{
    ...
    public partial class CreateDgOffersRequest
    {
        ...
        [JsonConstructor]
        public CreateDgOffersRequest(List<DgItinerary> itinerary, DgRequestType requestType, Dictionary<string, string> extAttributes, Option<DateTime?> bookingDateTime = default, Option<CreateAirlineDgSessionRequest?> session = default, Option<string?> entryPoint = default)
        {
            Itinerary = itinerary;
    ...
    public class CreateDgOffersRequestJsonConverter : JsonConverter<CreateDgOffersRequest>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateDgOffersRequest createDgOffersRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createDgOffersRequest.EntryPointOption.IsSet)
                writer.WriteString("entry_point", createDgOffersRequest.EntryPoint);
        }
    }
}
