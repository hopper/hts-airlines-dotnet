...
namespace Com.Hopper.Hts.Airlines.Spreedly.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", Com.Hopper.Hts.Airlines.Spreedly.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}